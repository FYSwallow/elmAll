...
const Cart = res => require(['@/common/cartControl/cartControl'], res)
const ConfirmOrder = res => require(['@/components/confirmOrder/confirmOrder'], res)
Vue.use(Router)
...
export default new Router({
    routes: [
        ...
        {path: '/confrimOrder', component: ConfirmOrder}
    ],
